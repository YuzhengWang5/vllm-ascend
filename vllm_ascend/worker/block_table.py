...
class BlockTable:
    ...
    def compute_slot_mapping(
        ...
        if self.dcp_world_size * self.pcp_world_size > 1:
            ...
            if "KV_CACHE_BLOCK_SIZE" in _compute_slot_mapping_kernel.arg_names:
                # vLLM #40996 split physical KV blocks into kernel blocks in
                # the slot-mapping kernel. Only pass these constexprs when
                # the imported vLLM kernel supports them.
